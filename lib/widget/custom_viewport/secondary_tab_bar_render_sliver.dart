...
class SecondaryTabBarRenderSliver extends RenderSliverSingleBoxAdapter {
  @override
  void performLayout() {
    if (child == null) {
    ...
    double paintOrigin = constraints.overlap - 44;
    paintOrigin = paintOrigin < 0 ? 0 : paintOrigin;
